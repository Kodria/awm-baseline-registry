...
assert.match(support, /\| `shell` \| `lint` \| `shellcheck-files` \| `shellcheck` \| `=0\.11\.0` \| Ubuntu, macOS, Windows \| Ubuntu: real tool; macOS\/Windows: contract \| certified \|/,
  'SUPPORT.md must not imply ShellCheck ran as a real tool outside Ubuntu');
assert.match(support, /\| `python` \| `lint` \| `ruff-native` \| `ruff` \| `=0\.16\.3` \| Ubuntu, macOS, Windows \| Ubuntu: 3\.9 \+ 3\.12 real; macOS\/Windows: 3\.12 smoke \| certified \|/,
...
for (const required of ['eslint', 'semgrep', '=8.57.1', 'Ubuntu, macOS, Windows', pins.resolvedAt, 'eslint@8.57.1']) assert.match(support, new RegExp(required.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')));
