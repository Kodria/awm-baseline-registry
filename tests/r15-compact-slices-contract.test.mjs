...
test('S3 pins the observed R4a release and keeps bundle/catalog delivery metadata consistent (R4-EVID-4)', () => {
  ...
  for (const [file, version] of [
    ['skills/development-process/SKILL.md', '2.0.0'], ['skills/writing-plans/SKILL.md', '2.1.0'],
    ['skills/subagent-driven-development/SKILL.md', '2.2.0'], ['skills/executing-plans/SKILL.md', '2.0.1'],
