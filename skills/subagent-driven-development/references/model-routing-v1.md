...
with target, runtime kind/version, and account scope digest. They never parse
policy JSON, calculate digests, or resolve models themselves.
...
`awm job routing-report` read-only. V1 remains unrouted unless explicitly
